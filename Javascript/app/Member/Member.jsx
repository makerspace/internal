			...
			<form className="uk-form">
				<fieldset >
					...
					<div className="uk-form-row">
						<label className="uk-form-label">{this.state.model.civicregno ? "Personnummer" : ""}</label>
						<div className="uk-form-controls">
							<input type="text" name="civicregno" value={this.state.model.civicregno} placeholder="Personnummer" onChange={this.handleChange} className="uk-form-width-large" />
						</div>
					</div>

					<div className="uk-form-row">
						<label className="uk-form-label">{this.state.model.firstname ? "Förnamn" : ""}</label>
						<div className="uk-form-controls">
							<input type="text" name="firstname" value={this.state.model.firstname} placeholder="Förnamn" onChange={this.handleChange} className="uk-form-width-large" />
						</div>
					</div>

					<div className="uk-form-row">
						<label className="uk-form-label">{this.state.model.lastname ? "Efternamn" : ""}</label>
						<div className="uk-form-controls">
							<input type="text" name="lastname" value={this.state.model.lastname} placeholder="Efternamn" onChange={this.handleChange} className="uk-form-width-large" />
						</div>
					</div>

					<div className="uk-form-row">
						<label className="uk-form-label">{this.state.model.email ? "E-post" : ""}</label>
						<div className="uk-form-controls">
							<div className="uk-form-icon">
								<i className="uk-icon-envelope"></i>
								<input type="text" name="email" value={this.state.model.email} placeholder="E-postadress" onChange={this.handleChange} className="uk-form-width-large" />
							</div>
						</div>
					</div>

					<div className="uk-form-row">
						<label className="uk-form-label">{this.state.model.phone ? "Telefonnummer" : ""}</label>
						<div className="uk-form-controls">
							<div className="uk-form-icon">
								<i className="uk-icon-phone"></i>
								<input type="text" name="phone" value={this.state.model.phone} placeholder="Telefonnummer" onChange={this.handleChange} className="uk-form-width-large" />
							</div>
						</div>
					</div>
				</fieldset>
				...
				<fieldset data-uk-margin>
					...
					<div className="uk-form-row">
						<label className="uk-form-label">{this.state.model.address_street ? "Address" : ""}</label>
						<div className="uk-form-controls">
							<input type="text" name="address_street" value={this.state.model.address_street} placeholder="Adress inkl gatunummer och lägenhetsnummer" onChange={this.handleChange} className="uk-form-width-large" />
						</div>
					</div>

					<div className="uk-form-row">
						<label className="uk-form-label">{this.state.model.address_extra ? "Address extra" : ""}</label>
						<div className="uk-form-controls">
							<input type="text" name="address_extra" value={this.state.model.address_extra} placeholder="Extra adressrad, t ex C/O adress" onChange={this.handleChange} className="uk-form-width-large" />
						</div>
					</div>

					<div className="uk-form-row">
						<div className="zipcode">
							<label className="uk-form-label">{this.state.model.address_zipcode ? "Postnummer" : ""}</label>
							<div className="uk-form-controls">
								<input type="text" name="address_zipcode" value={this.state.model.address_zipcode} placeholder="Postnummer" onChange={this.handleChange} className="uk-form-width-small" />
							</div>
						</div>

						<div className="city">
							<label className="uk-form-label">{this.state.model.address_city ? "Postort" : ""}</label>
							<div className="uk-form-controls">
								<input type="text" name="address_city" value={this.state.model.address_city} placeholder="Postort" onChange={this.handleChange} />
							</div>
						</div>
					</div>
