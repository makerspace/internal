 ...
 */
$config['site_title']           = "internal.makerspace.se"; 		// Site Title, example.com
$config['admin_email']          = "internal@makerspace.se"; 	// Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 60*60*12; 		// 12h - The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
