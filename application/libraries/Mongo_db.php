...
class Mongo_db
{
	...
	/**
	 * Class serves as a replacement for the Mongo class
	 * 
	 * @var string
	 * @access private
	 */
	...
	{
		$this->_class = (class_exists('MongoClient')) ? 'MongoClient' : 'Mongo'; 
	...
	*/
	...
	private function _connect()
	{
		...
		try
		{
			$this->_connection = new $this->_class($this->_connection_string, $options);
