...
-- Mon 06 Jul 2015 02:22:01 AM CEST
...
-- -----------------------------------------------------
-- Table `internal`.`accounting_instructions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `internal`.`accounting_instructions` ;

CREATE TABLE IF NOT EXISTS `internal`.`accounting_instructions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME NOT NULL,
  `updated_at` DATETIME NOT NULL,
  `title` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `internal`.`accounting_transactions` (
  ...
  `created_at` DATETIME NOT NULL,
  `updated_at` DATETIME NOT NULL,
  `accounting_instruction_id` INT(11) NOT NULL,
  ...
  `description` TEXT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_accounting_transactions_1_idx` (`accounting_instruction_id` ASC),
  INDEX `fk_accounting_transactions_2_idx` (`accounting_account_id` ASC),
  INDEX `fk_accounting_transactions_3_idx` (`accounting_cost_center_id` ASC),
  CONSTRAINT `fk_accounting_transactions_1`
    FOREIGN KEY (`accounting_instruction_id`)
    REFERENCES `internal`.`accounting_instructions` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Data for table `internal`.`accounting_accounts`
-- -----------------------------------------------------
START TRANSACTION;
USE `internal`;
INSERT INTO `internal`.`accounting_accounts` (`id`, `account_id`, `title`, `description`) VALUES (1, 1930, 'Bankonto', NULL);
INSERT INTO `internal`.`accounting_accounts` (`id`, `account_id`, `title`, `description`) VALUES (2, 2999, 'OBS-konto', NULL);
